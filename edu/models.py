...
class guruh(models.Model):
    ...
    def __str__(self):
        return str(self.guruh)+" "+str(self.uquvchi_id)
...
class Vaqtlar(models.Model):
    vaqt_start=models.TimeField()
    vaqt_end=models.TimeField()

    def __str__(self):
        return str(self.vaqt_start)
...
class guruh_kunlari(models.Model):
    ...
    vaqt_id=models.ForeignKey(Vaqtlar,on_delete=models.CASCADE)
